  ...
  ABOUT THE PORTER MODULE
  Siigna Porter utilises the Kabeja version 0.4 DXF import library.
  for DXF import operations. Kabeja is released under the Apavhe 2.0 licence, see below.
  ...
  KABEJA LICENCE AGREEMENT:
   ...
   1. Definitions.
      ...
      form, that is based n (or derived from) the Work and for which the
